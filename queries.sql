...
-- 8) Monthly net flows by category (if category inflows table loaded into DB as fact_category_inflows)
SELECT month AS period, category, SUM(net_inflow_crore) AS net_inflow_crore
